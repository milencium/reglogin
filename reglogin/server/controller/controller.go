...
import (
	"database/sql"
	"fmt"
	"github.com/milencium/reglogin/server/config"
	"net/http"
	"time"

	"github.com/milencium/reglogin/server/db"
	"github.com/milencium/reglogin/server/errors"
	"github.com/milencium/reglogin/server/utils"
